...
class PDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 10, f'Generated by {user} on {date_str}', 0, 0, 'C')
    ...
    # --- RAISE DEBIT NOTE (FIXED) ---
        ...
        with st.form("raise_form"):
            ...
            if submitted:
                ...
                # Save to DB - BROKEN INTO VARIABLES TO PREVENT SYNTAX ERRORS
            ...
            with tab1:
                with st.form("add_con"):
                    ...
                    if st.form_submit_button("Add"):
                        # Safe Insert
                        row_data = [int(datetime.now().timestamp()), n, d]
                        db_insert("Contractors", row_data)
